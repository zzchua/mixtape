define(function(require) {
	...
	$.ajax({
            ...
            $.each(response, function(i, val) {
               items.push("<div class='mix'><div class='name-header'><div class='user'><div class='user-circle'><img src='https://scontent-sjc2-1.xx.fbcdn.net/hphotos-xfp1/v/t1.0-9/12715794_1150327101644297_1371427251795969270_n.jpg?oh=f49c9852eb090c3aa04516d089c7ccb7&oe=57BE0CC5'/></div></div><div class='user-name'><h1>Gibby Pena</h1></div></div><div class='mix-detail'><div class='cover'><img src='" + response[i].cover + "' /></div><div class='detail-text'><h1>" + response[i].artist + "</h1><h2>" + response[i].songAlbum + "</h2><h3>" + response[i].message + "</h3></div><div class='redirect'><div class='redirect-icon'></div></div></div><div class='comment'><input type='text' class='inputs' placeholder='Comment here...' /><div class='send'><input type='submit' class='send-btn' value='Send'></div></div><div class='accent'></div>");
            });
